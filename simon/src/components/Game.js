...
class Game extends Component {
    ...
    render() {
      ...
      return (
        <div className="App">
            <h1>Simon says..</h1>
            <div className="col-xs-6" id="red" value="1"
                onClick={() => console.log('red')}
            >
            </div>
            <div className="col-xs-6" id="green" value="2"
                onClick={() => console.log('green')}
            >
            </div>
            <div className="col-xs-6" id="blue" value="3"
                onClick={() => console.log('blue')}
            >
            </div>
            <div className="col-xs-6" id="yellow" value="4"
